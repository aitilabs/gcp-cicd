...
docker tag demo-flask-app us-central1-docker.pkg.dev/cli-project-genai/python-apps/demo-flask-app
docker push us-central1-docker.pkg.dev/cli-project-genai/python-apps/demo-flask-app

gcloud run deploy demo-flask-app \
--image us-central1-docker.pkg.dev/cli-project-genai/python-apps/demo-flask-app \
--region us-central1